...
[![CI](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml/badge.svg)](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml) <!-- badge:files -->![264 arquivos](https://img.shields.io/badge/arquivos-264-blue)<!-- /badge --> <!-- badge:date -->![2026-03-25](https://img.shields.io/badge/atualizado-2026--03--25-green)<!-- /badge -->
...
| `api-integration-guide/` | <!-- count:api-integration-guide -->108<!-- /count --> | Guias de integração por domínio |
...
### Product (<!-- count:product -->53<!-- /count --> endpoints)
