...
**Last update:** 2025-07-31 12:34:41
...
Order update time, timestamp in seconds
...
After-sales type: 1-Refund only; 2-Return and refund
...
parent After sales order number
...
Status update time, millisecond timestamp
...
After-sales source: 1-user; 2-merchant; 3-platform customer service; 4-system
...
Changed after-sales order status: 5-Refunded
...
After-sales initiation source: 1-user; 2-merchant; 3-platform customer service; 4-system
