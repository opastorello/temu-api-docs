...
**edit goods compliance interface v2 version**
...
| 150019003 | The baseprice entered does not meet the requirements |
| 150019002 | Currency Parameter Error |
| 150019001 | The current site does not support queries. |
| 150011005 | {*} is not in the current store |
...
| 150010401 | Only one stock adjustment method can be active at a time. |
| 150010402 | skuId and outSkuSn cannot be provided together. |
