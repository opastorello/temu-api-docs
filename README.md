...
[![CI](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml/badge.svg)](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml) <!-- badge:files -->![290 arquivos](https://img.shields.io/badge/arquivos-290-blue)<!-- /badge --> <!-- badge:date -->![2026-08-26](https://img.shields.io/badge/atualizado-2026--08--26-green)<!-- /badge -->
...
| `api-integration-guide/` | <!-- count:api-integration-guide -->131<!-- /count --> | Guias de integração por domínio |
