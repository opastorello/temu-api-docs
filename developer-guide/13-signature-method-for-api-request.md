...
Assemble request parameters and common parameters

- 
Add common parameters to JSON object dictionary

- 
by $key in ascending order using ascii

- 
String concatenation $key and $value
...
Seamlessly concatenate strings. After concatenation, add **app_secret to the head and tail**** **. Assume **that app_secret **is `c7e0a1a63542be4de3cb5488f9fba8149e8fc290` 
 | 

```
c7e0a1a63542be4de3cb5488f9fba8149e8fc290access_token2nifvmpyymvypwmcms5ct4uqqudrwgpmzbcnmkt1jzjkuaf3x56iixymapp_keyf9d5cc931 3893a20d5aa85c654e8f503data_typeJSONsendRequestList[{"orderSendInfoList":[{"quantity":1,"orderSn":"211-21905473070712792","pa rentOrderSn":"PO-211-21905452099192792","goodsId":601099548666279,"skuId":17592352673534}],"carrierId":"699272611","tracking Number":"270324232756"}]sendType0timestamp1711009072typebg.logistics.shipment.confirmc7e0a1a63542be4de3cb5488f9fba8149e8fc290
```
...
Generate the signature sign from the above concatenated string

- 
The signature is signed using the `MD5`  method to generate an MD5 signature

- 
The upperCase method converts the MD5 signature to uppercase format
...
Insert the sign value into the original assembled JSON to construct a complete request body
 | 
...
Initiate an API request (taking JSON data format request as an example)
...
- 
Request body: `See the example of step 5 above` 
