...
[![CI](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml/badge.svg)](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml) <!-- badge:files -->![291 arquivos](https://img.shields.io/badge/arquivos-291-blue)<!-- /badge --> <!-- badge:date -->![2026-09-04](https://img.shields.io/badge/atualizado-2026--09--04-green)<!-- /badge -->
...
| `api-integration-guide/` | <!-- count:api-integration-guide -->132<!-- /count --> | Guias de integração por domínio |
| `api-reference/authorization/` | <!-- count:authorization -->7<!-- /count --> | OAuth e tokens de acesso |
| `api-reference/product/` | <!-- count:product -->56<!-- /count --> | Catálogo de produtos |
...
### Product (<!-- count:product -->56<!-- /count --> endpoints)
