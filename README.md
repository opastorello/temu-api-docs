...
[![CI](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml/badge.svg)](https://github.com/opastorello/temu-api-docs/actions/workflows/update-docs.yml) <!-- badge:files -->![292 arquivos](https://img.shields.io/badge/arquivos-292-blue)<!-- /badge --> <!-- badge:date -->![2026-09-21](https://img.shields.io/badge/atualizado-2026--09--21-green)<!-- /badge -->
...
| `api-reference/product/` | <!-- count:product -->57<!-- /count --> | Catálogo de produtos |
...
### Product (<!-- count:product -->57<!-- /count --> endpoints)
